...
#title="%wtitle" class="bold">%ctexts</a>.' % (wtitle,wdate, wtext, ctext,ctext)"""
...
retCوةode, choice = dialog.list_menu_multi(options, title="Choose one or more values", message="Choose one or more values", defaults=[])
