...
ztext = '''
    ...
    Introducing Work
        Writing Introductions
            ...
            Introductory sections for research dissertations, are normally much more complex than this and, as well as the elements above, may include the following: a synopsis of key literature/current state of knowledge, synopsis of methods, lists of research questions or hypotheses to be tested, significance of the study, recognition of the limitations of the study, reasons for personal interest in the topic.
                Establishing the importance of the topic:
                    One of the mst significant current discussions in legal and moral philosophy is ....
        ...
        Referring to literature
            ...
            General reference to previous research/scholarly activity (usually more than one author)
                ...
                There is a consensus among social scientisits that ....(e.g. Jones, 1987; Johnson, 1990; Smith, 1994).
            ...
            Reference to current state of knowledge
                ...
                MIF has been found to oppose the anti-inflammatory actions of X on Y (Alourfi, 2004).
            ...
            Reference to single investigations in the past: investigation prominent
                ...
                A longtitudinal study of X by Smith (2012) reports that ....
            ...
            Reference to what other writers do in their text (author as subject)
                Smith (2013) identifies poor food, bad housing, inadequate hygiene and large families as the major causes of ....
                ...
                Smith (2013) uses examples of these various techniques as evidence that ....
    ...
    Describing Methods
        ...
        Giving reasons why a particular method was adopted or rejected
            ...
            A major probem with the experimental method is that ....
    ...
    Reporting Results
            The standard approach to this section of a dissertation is to merely present the results, without elaborate discussion or comment. This does not mean that you do not need any text to describe data presented in tables and figures. Writers usually comment on the significant data presented in the tables and figures. This often takes the form of the location or summary statement, which identifies the table or figure and indicates its content. This is normally followed by a statement or statements which point out and describe the relevant or significant data. All your tables should be numbered and given a title.
            ...
            Explanations for results:
                ...
                Some authors 9,30 have speculated that ....
    ...
    Suggestions for future work
                However, more research on this topic needs to be undertaken before the association between X and Y is more clearly understood.
                    ...
                    Several questions reamain unanwswered at present.
    ...
    Writing Conclusions
        ...
        Whilst this study did not confirm X, it did partially substantiate ....
            ...
            Although the current study is based on a small sample of participants, the findings suggest that ….
    ...
    Writing Definitions
            ...
            of touch reading and writing for blind pople in which raised dots on paper represent the letters of the alphabet.
        ...
        Classifying and Listing
            ...
            Smith (1966)	divided
            classified
            grouped	Xs	into two broad types: Xi's and Xii's
            Thomas and Nelson (1996) describe	four basic types of	validity: logical, content, criterion and contruct.
            ...
            During his tour of Britian, he visited the following industrial centres: Manchester, Leeds, Bristol, and Birmingham.
        ...
        Describing Causes and Effects
            ...
            Consequently,
            Because of this,
            As a result (of this),	when they grow up, it will probably be difficult for them to find work.
        ...
        Writing about the Past
            ...
            Upbasic to now, the research has tended to focus on X rather than on Y.
            ...
            The new material has been shown to enhance cooling properties (Smith, 1985, Jones, 1987, Johnson, 1992).
            Invasive plants have been identified as major contributing factors for the decline of many North American species (1).
            A considerable amount of literature has been published on X.
        Describing Trends and Projections
                A trend is a description of change over time. A projection is a prediction of future change. Trends and projections are usually illustrated using line graphs in which the horizontal axis represents time. Some of the language commonly used for writing about trends and projections is given below.
                Describing trends

                The graph shows that there has been a	slight
                gradual
                steady
                marked
                steep
        ...
        Describing ranges
            ...
            The mean income of the bottom 20 percent of U.S. families declined from $10,716 in 1970 to $9,833 in 1990.
            ...
            They calculated ranges of journal use from 10.7%–36.4% for the humanities, 25%–57% for the ......
            Rates of decline ranged from 2.71– 0.08 cm day-1 (Table 11) with a mean of 0.97 cm day-1.
    ...
    Transition Statements
            In longer pieces of work, writers are expected to indicate to the reader when they are moving from one topic to another, or from on section of text to another. These are known as transition statements and some examples of these are given below.
        ...
        Previewing a following section
            This raises questions about .... which will seek to answer in the next chapter.
                The next chapter describes synthesis and evaluation of ....
                The section that follows, it will be argued that ....
