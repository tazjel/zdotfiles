...
# sudo update-rc.d web2py-mailcaptcha defaults
#
# Provides:          web2py-mailcaptcha
# Required-Start:    $local_fs $remote_fs
# Required-Stop:     $local_fs $remote_fs
# Default-Start:     2 3 4 5
# Default-Stop:      S 0 1 6
# Short-Description: web2py-mailcaptcha initscript
# Description:       This file starts up the web2py-mailcaptcha server.
### END INIT INFO

# Author: Szabolcs Gyuris <szimszon @ oregpreshaz.eu> based on Mark Moore <mark.moore@fonjax.com>'s work.

PATH=/usr/sbin:/usr/bin:/sbin:/bin


DESC="Web MailCaptcha"
NAME=web2py-mailcaptcha
PIDDIR=/var/run/$NAME
PIDFILE=$PIDDIR/$NAME.pid
SCRIPTNAME=/etc/init.d/$NAME
DAEMON=/usr/bin/python
DAEMON_DIR=
DAEMON_ARGS="web2py.py -R applications/mailcaptcha/private/mailcaptcha.py -S mailcaptcha -M"
DAEMON_USER=web2py
...
do_start()
{
	...
	start-stop-daemon --stop --test --quiet --pidfile $PIDFILE --name web2py-mailcaptcha \
		&& return 1

	start-stop-daemon --start --quiet --background --pidfile $PIDFILE --name web2py-mailcaptcha\
